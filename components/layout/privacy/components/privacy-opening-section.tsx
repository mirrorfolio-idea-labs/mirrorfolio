...
export function PrivacyOpeningSection() {
  return (
        ...
        <div className="max-w-2xl">
          ...
          <FadeIn delay={0.25}>
            <p className="text-body-lg text-foreground leading-relaxed mb-4">
              A product that promises dignity should be transparent about data.
            </p>
            <p className="text-body-lg text-muted-foreground leading-relaxed mb-8">
              This page explains exactly what we collect, what we don&apos;t,
              and why.
            </p>
          </FadeIn>
          ...
          <FadeIn delay={0.35}>
            <div className="relative mt-12">
              ...
              <p className="text-body text-foreground leading-relaxed pl-6">
                No legal jargon designed to confuse.
                <span className="block mt-2 text-muted-foreground">
                  Plain language about what happens with your data.
                </span>
              </p>
            </div>
          </FadeIn>
